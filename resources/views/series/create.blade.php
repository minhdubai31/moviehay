<x-layout>
    <div class="bg-gray-100 max-w-5xl m-auto pb-3 rounded-lg">
        <h1 class="font-medium text-3xl pt-10 text-orange-600 text-center">Thêm seri phim mới</h1>
        <form id="episode-form" action="/series/store" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="max-w-lg m-auto">
                ...
                <div class="mb-6">
                    ...
                    <img class="hidden rounded-lg mb-2 h-56" src="" id="image-preview1" />
                    <label for="sr_poster"
